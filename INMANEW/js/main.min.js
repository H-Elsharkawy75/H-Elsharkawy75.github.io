...
"use strict";
var textAnimateTimer, wordAnimateTimer;
...
var teamSliderInterval, mobileSliderInterval, mobileSliderInterval2, sectionAnimationsSpeed = 500,
    fullpageSpeed = 500,
    isMainPage = !1,
    amountOfFullpageSlides = 0,
    isFullpagePage = !1,
    windowWidth = document.documentElement.clientWidth;

function animateFormProgressBar(e) {
    var t = (e + 1) / $(".contacts__form__segment").length;
    $(".contacts__form__progressbar__inner").css("transform", "scaleX(" + t + ")")
}
...
function checkFormSegmentSiblings(e) {
    var t = !0;
    return e.find("textarea,input").each(function() {
        "phone" == !$(this).attr("type") && ("" == $(this).val() && (t = !1), "email" == $(this).attr("type") && (isEmail($(this).val()) || (t = !1)))
    }), t
}

function checkIfMainPage() {
    $("body").hasClass("body--main") && (isMainPage = !0)
}

function clearContactsForm() {
    setTimeout(function() {
        $(".contacts__form__progressbar__inner").css("transform", "scaleX(0)"), $(".contacts__form__segment").removeClass("contacts__form__segment--shown"), $(".contacts__form").find("input:not([type='radio'])").val(""), $(".contacts__form").find("textarea").val("")
    }, 800)
}

function showFormSegment(e) {
    var t = $(".contacts__form").find(".contacts__form__segment").eq(e),
        n = window.innerHeight;
    if (t.addClass("contacts__form__segment--shown"), setTimeout(function() {
            $(".contacts__form__wrap").animate({
                scrollTop: t.position().top - n / 5
            }, 500), animateFormProgressBar(e), 0 < t.find("input,textarea").length && t.find("input,textarea")[0].focus()
        }, 500), 1 == e) {
        var i = $("#name").val();
        $("#person-name").html(i)
    }
...
$(document).ready(function() {
    $("body").hasClass("body--main") && (isMainPage = !0), $("body").hasClass("body--fullpage") && (isFullpagePage = !0), initHomepageTeamSlider(), initHomepageVisionSlider(), initHomepageAboutUsSlider(), initHomepageStepsSlider(), amountOfFullpageSlides = $(".section").length, $("#fullpage").fullpage({
        ...
        onLeave: function(e, t, n) {
            $.fn.fullpage.setMouseWheelScrolling(!1), $.fn.fullpage.setAllowScrolling(!1), fadeOutContent();
            var i = t.index;
            changeActiveMenuItem(i), changeMenuType(i), setTimeout(function() {
                checkScrollButtons(i), resetSlideInnerScroll(i), checkMobileSlider(i), checkFirstSlide(i), checkAnimatedMedia(i), checkAnimatedText(i), checkAnimatedButtons(i), checkHomepageCards(i), checkHomepageSteps(i), checkTeamSlider(i), checkPhotography(i)
            }, fullpageSpeed + sectionAnimationsSpeed), setTimeout(function() {
                $.fn.fullpage.setMouseWheelScrolling(!0), $.fn.fullpage.setAllowScrolling(!0)
            }, fullpageSpeed + 4 * sectionAnimationsSpeed)
        }
    });
    var n = $("body").scrollTop();
    $("input, textarea, select").focus(function(e) {
        var t = $(e.target).offset();
        n = $("body").scrollTop(), $("body").scrollTop(t.top - 100)
    }), $("input, textarea, select").focusout(function(e) {
        $("body").scrollTop(n)
    }), isFullpagePage && $.fn.fullpage.setAllowScrolling(!1), $(".section__controls__button--next").click(function() {
        ...
        var e = $(this).parents(".menu__list__unit").index();
        $(".menu__bg__unit").removeClass("menu__bg__unit--active"), $(".menu__bg__unit").eq(e).addClass("menu__bg__unit--active")
        ...
        var a = e.length;
        $.each(e, function(e, t) {
            var n = '<span class="text-animated--eachWord__word"><span class="text-animated--eachWord__word__inner">'.concat(t, " </span></span>");
            e == a - 1 && (n = '<span class="text-animated--eachWord__word"><span class="text-animated--eachWord__word__inner">'.concat(t, "</span></span>")), i.append(n)
        })
    }), $(document).on("click", ".mobile-slider .slick-next", function() {
        var e = $(this).parents(".slick-slider:not(.homepage__section__steps):not(.homepage__team__wrap)");
        clearInterval(mobileSliderInterval), setMobileSliderInterval(e)
    }), $(document).on("click", function(e) {
        var t, n = $(e.target);
        n.hasClass("nav") || n.parents().hasClass("nav") ? n.hasClass("nav__menu__unit") || n.parents().hasClass("nav__menu__unit") ? (t = n.hasClass("nav__menu__unit") ? n.index() : n.parents(".nav__menu__unit").index(), isMainPage && 4 < t ? $.fn.fullpage.moveTo(t, 0) : $.fn.fullpage.moveTo(t + 1, 0), $(".nav").removeClass("nav--hover")) : $(".nav").addClass("nav--hover") : $(".nav").removeClass("nav--hover")
        ...
        var e = $(this),
            t = e.find(".team__slider__info"),
            n = e.find(".team__slider__images"),
            i = e.find(".team__slider__controls__unit--prev"),
            a = e.find(".team__slider__controls__unit--next");
        n.on("init", function(e, t) {
            var n = t.currentSlide,
                i = t.$slides.eq(n);
            i.next(".slick-slide").addClass("team__slider__images__unit--highlighted"), i.next(".slick-slide").nextAll(".team__slider__images__unit").addClass("team__slider__images__unit--moved"), i.next(".slick-slide").nextAll(".team__slider__images__unit").eq(0).addClass("team__slider__images__unit--highlighted--next"), i.next(".slick-slide").nextAll(".team__slider__images__unit").eq(1).addClass("team__slider__images__unit--highlighted--next--next")
            ...
            var a = i;
            (n = t.$slides.eq(a)).next(".slick-slide").addClass("team__slider__images__unit--highlighted"), n.next(".slick-slide").nextAll(".team__slider__images__unit").addClass("team__slider__images__unit--moved"), n.next(".slick-slide").nextAll(".team__slider__images__unit").eq(0).addClass("team__slider__images__unit--highlighted--next"), n.next(".slick-slide").nextAll(".team__slider__images__unit").eq(1).addClass("team__slider__images__unit--highlighted--next--next")
        }), n.slick({
            draggable: !1,
            acessibility: !1,
            swipe: !1,
    ...
    }), $(".team__strengths__slider").on("beforeChange", function(e, t, n, i) {
        clearInterval(mobileSliderInterval), setMobileSliderInterval($(".team__strengths__slider"))
    }), $(".team__strengths__slider").slick({
        prevArrow: "",
        mobileFirst: !0,
        dots: !0
    }), $(".team__diversity__text").on("beforeChange", function(e, t, n, i) {
        clearInterval(mobileSliderInterval2), setMobileSliderInterval($(".team__diversity__text"))
    ...
    }), $("[data-fancybox]").fancybox({}), $(".team__video__button").click(function() {
        var e = $(".team__video video");
        $("html, body").animate({
            scrollTop: $(".team__video").offset().top
        }, 500), $(".team__video").addClass("team__video--expanded"), $(".team").addClass("team--video"), $("body").removeClass("body--loaded"), e.prop("muted", !1)
    }), $(".team__video__close").click(function() {
        var e = $(".team__video video");
        $(".team__video").removeClass("team__video--expanded"), $(".team").removeClass("team--video"), $("body").addClass("body--loaded"), e.prop("muted", !0)
        ...
        var e = $(this),
            t = e.parents(".photography__hero"),
            n = t.find(".photography__hero__controls__unit--prev"),
            i = t.find(".photography__hero__controls__unit--next");
        e.slick({
            ...
            customPaging: function(e, t) {
                var n = $(e.$slides[t]).find(".photography__hero__slider__unit__image").css("background-image");
                return $("<div class='photography__hero__slider__preview__unit' style='background-image:" + n + "'></div>")
            }
        })
    }), $(".photography__packages__unit__title").click(function() {
        var e = $(this).parents(".photography__packages__unit"),
            t = e.siblings(".photography__packages__unit");
        t.removeClass("photography__packages__unit--expanded"), t.find(".photography__packages__unit__body").css("max-height", "0px");
        var n = e.find(".photography__packages__unit__body__inner"),
            i = e.find(".photography__packages__unit__body"),
            a = n.outerHeight(!0);
        e.hasClass("photography__packages__unit--expanded") ? (e.removeClass("photography__packages__unit--expanded"), i.css("max-height", "0px")) : (e.addClass("photography__packages__unit--expanded"), i.css("max-height", a + "px"))
        ...
        $(".contacts__form").removeClass("contacts__form--shown"), clearContactsForm()
    }), $(".contacts__form__footer__back").click(function() {
        $(".contacts__form").removeClass("contacts__form--shown"), clearContactsForm()
    }), $("#open-form").click(function() {
        $(".contacts__form").addClass("contacts__form--shown"), showFormSegment(0)
    }), $(".contacts__form input ").on("keyup", function(e) {
        var t = e.keyCode ? e.keyCode : e.which,
            n = $(this).parents(".contacts__form__segment"),
            i = n.index(),
            a = checkFormSegmentSiblings(n);
            
            if($("#name").val() !='' && i==0){
                 "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
            
            } else if( $.trim($("#company").val()).length > 1 && i==1 ) {
                 "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
    
            } else if($.trim($("#services").val()).length && i==2){
                 "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
    
            } else if($("#start-date").val() !='' && $("#finish-date").val() =='' && i==3 && "13" == t){
                $('#finish-date').focus();
            } else if($("#start-date").val() !='' && $("#finish-date").val() !='' && i==3){
                "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
    
            } else if($("#budget-1").val() !='' && i==4){
                 "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
    
            } else if($("#email").val() !='' && $("#g-recaptcha-response").val() !='' &&  i==5){
                ...
                if(!emailReg.test(emailaddressVal)) {
                    ...
                    if((typeof recaptchaVal !== 'undefined') && (recaptchaVal !='')){
                        "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
    
                    }
                }
            } else if($("#g-recaptcha-response").val() !='' && i==6){
                
                "13" == t && ($(this).is("#start-date") || $(this).is("#email") ? (console.log(1), console.log($(this)), "" != $(this).val() && $(this).is("#start-date") ? $("#finish-date").focus() : "" != $(this).val() && $(this).is("#email") && ($("#phone").focus(), console.log(2))) : a && showFormSegment(i + 1))
    
            }
        }), $(".contacts__form textarea").on("keypress", function(e) {
        var t = e.keyCode ? e.keyCode : e.which,
            n = $(this).parents(".contacts__form__segment"),
            i = n.index();
            
            if($("#name").val() !='' && i==0){
                checkFormSegmentSiblings(n) && "13" == t && showFormSegment(i + 1)
            } else if( $.trim($("#company").val()).length > 1 && i==1 ) {
                checkFormSegmentSiblings(n) && "13" == t && showFormSegment(i + 1)
            } else if( $.trim($("#services").val()).length > 1 && i==2){
                checkFormSegmentSiblings(n) && "13" == t && showFormSegment(i + 1)
            } else if($("#start-date").val() !='' && $("#finish-date").val() =='' && i==3){
                //$('#finish-date').focus();
            } else if($("#start-date").val() !='' && $("#finish-date").val() !='' && i==3){
        ...
        var e = $(".contacts__form__segment--shown").last(),
            t = e.index();
        if($("#name").val() !='' && t==0){
            checkFormSegmentSiblings(e) && showFormSegment(t + 1)
        } else if(  $.trim($("#company").val()).length > 1 && t==1 ) {
            checkFormSegmentSiblings(e) && showFormSegment(t + 1)
        } else if($("#services").val() !='' && t==2){
            checkFormSegmentSiblings(e) && showFormSegment(t + 1)
        } else if($("#start-date").val() !='' && $("#finish-date").val() =='' && t==3){
            $('#finish-date').focus();
        } else if($("#finish-date").val() !='' && t==3){
            checkFormSegmentSiblings(e) && showFormSegment(t + 1)
        } else if($("#budget-1").val() !='' && t==4){
            checkFormSegmentSiblings(e) && showFormSegment(t + 1)
        } else if($("#email").val() !='' && $("#g-recaptcha-response").val() !='' &&  t==5){
            var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
            var emailaddressVal = $("#email").val();
            var recaptchaVal = $("#g-recaptcha-response").val();
            if(!emailReg.test(emailaddressVal)) {
        ...
        } else if($("#g-recaptcha-response").val() !='' && t==6){
            checkFormSegmentSiblings(e) && showFormSegment(t + 1)
        } 
        ...
        $(this).hasClass("intro__scroll--work") ? $.fn.fullpage.moveSectionDown() : animateIntro()
    })
});
...
function initHomepageTeamSlider() {
    $(".homepage__team").each(function() {
        var e = $(this),
            t = e.find(".homepage__team__wrap"),
            n = e.find(".homepage__team__controls__unit--prev"),
            i = e.find(".homepage__team__controls__unit--next");
        t.on("init", function(e, t) {
            var n = t.currentSlide,
                i = t.$slides.eq(n),
                a = i,
                s = i.nextAll().eq(3);
            a.addClass("homepage__team__unit--side homepage__team__unit--side--left"), s.addClass("homepage__team__unit--side homepage__team__unit--side--right")
            ...
            var a = i,
                s = n = t.$slides.eq(a),
                o = n.nextAll().eq(3);
            s.addClass("homepage__team__unit--side homepage__team__unit--side--left"), o.addClass("homepage__team__unit--side homepage__team__unit--side--right")
        }), t.on("afterChange", function(e, t, n) {
            var i = n;
            findCenterTeamSlide(t.$slides.eq(i)), setTeamSliderInterval()
        }), t.slick({
...
function resetSlideInnerScroll(e) {
    var t = $(".section").eq(e),
        n = t.find(".fp-scroller");
    if (0 < n.length) {
        var i = t.find(".iScrollIndicator"),
            a = n.attr("style"),
            s = i.attr("style");
        a = a.replace(/transform:\s*(.*?)\s*;/g, "transform:translate(0px,0px) translateZ(0px)"), s = s.replace(/transform:\s*(.*?)\s*;/g, "transform:translate(0px,0px) translateZ(0px)"), i.attr("style", s), n.attr("style", a), $.each(window.fp_scrolloverflow.iscrollHandler.iScrollInstances, function(e, t) {
            n[0] == t.scroller && (t.y = 0)
        })
    }
}

function checkScrollButtons(e) {
    0 == e ? $(".section__controls").addClass("section__controls--first") : e == amountOfFullpageSlides - 1 && $(".section__controls").addClass("section__controls--last"), $(".section__controls").addClass("section__controls--shown")
}

function findCenterTeamSlide(e) {
    var t, n = document.documentElement.clientWidth;
    (0 <= (t = n < 760 ? -1 : n < 1024 ? 0 : 1) ? e.nextAll().eq(t) : e).addClass("homepage__team__unit--timer")
}
...
function initHomepageAboutUsSlider() {
    $(".homepage__section__text--aboutus").on("beforeChange", function(e, t, n, i) {
        2 == i ? $(this).prev(".homepage__section__title").addClass("homepage__section__title--alt") : $(this).prev(".homepage__section__title").removeClass("homepage__section__title--alt")
...
function changeMenuType(e) {
    0 == e || e == amountOfFullpageSlides - 1 ? ($(".header").removeClass("header--translated"), $(".menu__burger").removeClass("menu__burger--shown")) : ($(".header").addClass("header--translated"), $(".menu__burger").addClass("menu__burger--shown"))
}

function changeActiveMenuItem(e) {
    var t, n = $(".nav__menu__unit"),
        i = "nav__menu__unit--active nav__menu__unit--prev";
    n.removeClass(i), (t = isMainPage ? e < 8 && 4 <= e ? (n.eq(4).addClass(i), n.eq(e + 1)) : 7 < e ? n.eq(e + 1) : n.eq(e) : n.eq(e)).addClass(i), t.prevAll(".nav__menu__unit").addClass("nav__menu__unit--prev")
}

function checkFirstSlide(e) {
    0 != e ? $(".nav").addClass("nav--filled") : $(".nav--filled").removeClass("nav--filled")
}

function fadeOutContent() {
    clearTimeout(textAnimateTimer), clearTimeout(wordAnimateTimer), clearInterval(teamSliderInterval), clearInterval(mobileSliderInterval), $(".text-animated--eachWord__word__inner").removeClass("text-animated--eachWord__word__inner--visible"), $(".text-animated--eachWord--visible").removeClass("text-animated--eachWord--visible"), $(".text-animated--shifted--visible").removeClass("text-animated--shifted--visible"), $(".button--animated--visible").removeClass("button--animated--visible"), $(".homepage__section__media--shown").removeClass("homepage__section__media--shown"), $(".homepage__section__cards__unit--shown").removeClass("homepage__section__cards__unit--shown"), $(".homepage__section__steps__unit--shown").removeClass("homepage__section__steps__unit--shown"), $(".homepage__team__unit--shown").removeClass("homepage__team__unit--shown"), $(".homepage__team__unit--timer").removeClass("homepage__team__unit--timer"), $(".photo__grid__column__unit--shown").removeClass("photo__grid__column__unit--shown"), $(".mobile-slider--shown").removeClass("mobile-slider--shown"), $(".intro__scroll--work").removeClass("intro__scroll--shown"), $(".section__controls").removeClass("section__controls--first section__controls--last")
}

function checkAnimatedMedia(e) {
    $(".section").eq(e).find(".homepage__section__media").each(function(e, t) {
        var n = e,
            i = $(this);
        setTimeout(function() {
            i.addClass("homepage__section__media--shown")
        }, 100 * n)
    })
}

function checkMobileSlider(e) {
    var t = $(".section").eq(e);
    t.find(".mobile-slider").addClass("mobile-slider--shown");
    var n = t.find(".slick-slider:not(.homepage__section__steps):not(.homepage__team__wrap)"),
        i = n.slick("slickCurrentSlide");
    0 < n.length && (setMobileSliderInterval(n), n.slick("slickGoTo", i + 1, !0), setTimeout(function() {
        n.slick("slickGoTo", i, !0)
    }, 110))
}

function checkHomepageCards(e) {
    $(".section").eq(e).find(".homepage__section__cards__unit").addClass("homepage__section__cards__unit--shown")
}

function checkPhotography(e) {
    $(".section").eq(e).find(".photo__grid__column__unit").addClass("photo__grid__column__unit--shown")
}

function checkHomepageSteps(e) {
    $(".section").eq(e).find(".homepage__section__steps__unit").addClass("homepage__section__steps__unit--shown")
}

function checkAnimatedText(e) {
    var t = $(".section").eq(e);
    t.find(".intro__scroll--work").addClass("intro__scroll--shown"), t.find(".text").each(function(e, t) {
        var n = e,
            i = $(this);
        textAnimateTimer = setTimeout(function() {
            i.hasClass("text-animated--eachWord") ? (i.addClass("text-animated--eachWord--visible"), i.find(".text-animated--eachWord__word__inner").each(function(e, t) {
                var n = e,
                    i = $(this);
                wordAnimateTimer = setTimeout(function() {
                    i.addClass("text-animated--eachWord__word__inner--visible")
                }, 100 * n)
            })) : i.hasClass("text-animated--shifted") && i.addClass("text-animated--shifted--visible")
        }, 100 * n)
    })
}

function setTeamSliderInterval() {
    clearInterval(teamSliderInterval), teamSliderInterval = setInterval(function() {
        $(".homepage__team__wrap").slick("slickNext")
    }, 4e3)
}

function setMobileSliderInterval(e) {
    e.hasClass("team__diversity__text") ? (clearInterval(mobileSliderInterval2), mobileSliderInterval2 = setInterval(function() {
        e.slick("slickNext")
    }, 8e3)) : (clearInterval(mobileSliderInterval), mobileSliderInterval = setInterval(function() {
        e.slick("slickNext")
    }, 8e3))
}

function checkTeamSlider(e) {
    var t = $(".section").eq(e),
        n = t.find(".homepage__team__wrap"),
        i = t.find(".homepage__team__unit--side--left").nextAll(".homepage__team__unit"),
        a = [t.find(".homepage__team__unit--side--left")];
    t.find(".homepage__team__unit--side--left").prevAll(".homepage__team__unit").addClass("homepage__team__unit--shown"), i.each(function(e, t) {
        a.push($(this))
    }), $.each(a, function(e, t) {
        var n = t;
        e < 5 ? setTimeout(function() {
            n.addClass("homepage__team__unit--shown")
        }, 100 * e) : n.addClass("homepage__team__unit--shown")
    }), findCenterTeamSlide(n.find(".slick-current")), 0 < n.length && setTeamSliderInterval()
}

function checkAnimatedButtons(e) {
    $(".section").eq(e).find(".button--animated").each(function(e, t) {
        var n = e,
            i = $(this);
        setTimeout(function() {
            i.addClass("button--animated--visible")
        }, 100 * n)
    })
}

function animateIntro() {
    $(".header").addClass("header--shown"), isMainPage && ($(".intro").addClass("intro--animated"), $(".nav").addClass("nav--shown"), setTimeout(function() {
        checkScrollButtons(0), checkAnimatedText(0), setTimeout(function() {
...
function detectSwipe() {
    ...
    e.addEventListener("touchstart", function(e) {
        ...
        e.changedTouches[0].screenY < t && animateIntro()
    }, !1)
}

function detectWheel() {
    $(".intro").on("wheel", function(e) {
        1 == Math.sign(e.originalEvent.deltaY) && animateIntro()
    })
}

function addHeaderListener() {
    $(window).on("load scroll", function() {
        100 < $(window).scrollTop() ? ($(".header").addClass("header--translated"), $(".menu__burger").addClass("menu__burger--shown")) : ($(".header").removeClass("header--translated"), $(".menu__burger").removeClass("menu__burger--shown"))
    })
}

function checkFadeElementsOnRegularPage() {
    $(".text").each(function(e, t) {
        ...
        $(this).isInViewport() && $(this).addClass("team__video--shown")
    }), $(".team__slider__images").each(function() {
        var e = $(this).parents(".team__slider");
        if ($(this).isInViewport()) {
            var t = e.find(".team__slider__images__unit.slick-current"),
                n = [t],
                i = t.nextAll(".team__slider__images__unit");
            t.prevAll(".team__slider__images__unit").addClass("team__slider__images__unit--shown"), i.each(function(e, t) {
                n.push($(this))
            }), $.each(n, function(e, t) {
                var n = t;
                e < 5 ? setTimeout(function() {
                    n.addClass("team__slider__images__unit--shown")
                }, 100 * e) : n.addClass("team__slider__images__unit--shown")
            }), e.find(".team__slider__info__unit").addClass("team__slider__info__unit--shown"), e.find(".team__slider__controls").addClass("team__slider__controls--shown")
        }
    }), $(".team__strengths__slider").each(function() {
        var e = $(this);
        e.isInViewport() && e.addClass("team__strengths__slider--shown")
    }), $(".page__media").each(function() {
        var e = $(this);
        e.isInViewport() && e.addClass("page__media--shown")
    }), $(".button--animated").each(function(e, t) {
        var n = e,
            i = $(this);
        i.isInViewport() && setTimeout(function() {
            i.addClass("button--animated--visible")
        }, 100 * n)
    }), $(".mobile-slider:not(.mobile-slider--shown)").each(function() {
        var e = $(this);
        if (e.isInViewport()) {
            e.addClass("mobile-slider--shown");
            var t = e.slick("slickCurrentSlide");
            0 < e.length && (setMobileSliderInterval(e), e.slick("slickGoTo", t + 1, !0), setTimeout(function() {
                e.slick("slickGoTo", t, !0)
            }, 110))
        }
    }), $(".photography__gallery__unit").each(function() {
        var e = $(this);
        e.isInViewport() && e.addClass("photography__gallery__unit--shown")
    }), $(".photography__person__image").each(function() {
        var e = $(this);
        e.isInViewport() && e.addClass("photography__person__image--shown")
    }), $(".photography__packages__unit").each(function() {
        var e = $(this);
        e.isInViewport() && e.addClass("photography__packages__unit--shown")
    }), $(".form__unit").each(function() {
        var e = $(this);
        e.isInViewport() && e.addClass("form__unit--shown")
    })
}
$(window).on("resize", function() {
    ...
    checkIfMainPage(), $(".preloader").addClass("preloader--hidden"), $("body").addClass("body--loaded"), addHeaderListener(), setTimeout(function() {
        $(".intro").addClass("intro--loaded"), isMainPage || isFullpagePage || ($(".header").addClass("header--shown"), checkFadeElementsOnRegularPage()), isFullpagePage && !isMainPage && ($(".header").addClass("header--shown"), $(".nav").addClass("nav--shown"), setTimeout(function() {
            checkAnimatedText(0), checkAnimatedMedia(0), checkScrollButtons(0), $.fn.fullpage.setAllowScrolling(!0)
        }, 1e3))
    }, 1e3), isMainPage && setTimeout(function() {
        detectWheel(), detectSwipe()
    }, 4e3)
...
$(document).ready(function() {
    var a, n, e = $(".sparkles"),
        s = 70;
    for (var t = 0; t < 500; t++) {
        a = t % 2 == 0 ? "sparkles__unit--medium" : t % 3 == 0 ? "sparkles__unit--big" : "", n = void 0, n = $(".sparkles__unit").eq(0).clone(), e.append(n), n.css({
            top: 100 * Math.random() + "%",
            left: 100 * Math.random() + "%",
            webkitAnimationDelay: Math.random() * s + "s",
            mozAnimationDelay: Math.random() * s + "s"
        }).addClass(a), e.append(n)
    }
});
